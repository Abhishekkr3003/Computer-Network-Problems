...
int DL_PDU::getPID() const
{
    return this->pID;
}

void DL_PDU::setPID(int pID)
{
    this->pID = pID;
}
...
int DL_PDU::getSrc() const
{
    return this->src;
}

void DL_PDU::setSrc(int src)
{
    this->src = src;
}

int DL_PDU::getDest() const
{
    return this->dest;
}

void DL_PDU::setDest(int dest)
{
    this->dest = dest;
}
